Emulate_graph <- function(p, perc1 = 0.05, perc2 = 0.05, length_var1 = 3, length_var2 = 3){
  ...
  # a <- round(number_edges*perc1, digits = 0)  #Anzahl Veränderungen Schritt 1
  # b <- round(number_edges*perc2, digits = 0) #Anzahl Veränderungen Schritt 2
  ...
  a <- round(gsize(graph_1)*perc1, digits = 0)  #Anzahl Veränderungen Schritt 1
  b <- round(gsize(graph_1)*perc2, digits = 0) #Anzahl Veränderungen Schritt 2
